...
public class AckConfigCommand extends BaseConfigCommand {
    protected AckConfigCommand(DeviceId deviceId, Duration standbyTimeout, Duration heartbeatInterval) {
        super(deviceId, DeviceCommandType.ACK_CONFIG, standbyTimeout, heartbeatInterval);
    }
